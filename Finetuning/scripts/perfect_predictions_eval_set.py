...
def check_predictions(prediction_folder, target_file):
    ...
    for f in prediction_files:
        ...
        checkpoint=prediction_file.split("-")[-1]
        print("Checkpoint {}: {} predictions equal out of {} ({} %)".format(checkpoint, number_equal, len(predictions), round(100*number_equal/len(predictions),2)))
...
if __name__ == "__main__":
    ...
    check_predictions(args.prediction_folder, args.target_file)